...
#ifdef DEBUG_I2C
	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_MW: 0x%02x,0x%02x,0x%02x,0x%02x\r\n\0"),devAddress,devAddressLength, (u16)(byteAddress), xBytes );
...
#ifdef DEBUG_I2C
	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_MR: 0x%02x,0x%02x,0x%02x,0x%02x\r\n\0"),devAddress,devAddressLength, (u16)(byteAddress), xBytes );
	CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
...
#ifdef DEBUG_I2C
		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_BUSIDLE(%d): 0x%02x\r\n\0"),reintentos,TWIE.MASTER.STATUS );
		CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
...
//	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_BUSIDLE ERROR!!: 0x%02x\r\n\0"),TWIE.MASTER.STATUS );
//	CMD_write( stdout_buff, sizeof(stdout_buff) );
	return(false);
}
//------------------------------------------------------------------------------------
...
#ifdef DEBUG_I2C
	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_SLA: 0x%02x,0x%02x\r\n\0"),txbyte, currentStatus );
	CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
...
i2c_exit:
	if ( !ret_code ) {
//		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_ADDR_ERROR: 0x%02x,0x%02x\r\n\0"),txbyte,currentStatus );
//		CMD_write( stdout_buff, sizeof(stdout_buff) );
	}
	return(ret_code);
}
...
#ifdef DEBUG_I2C
		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_SR_H: 0x%02x,0x%02x\r\n\0"),txbyte,currentStatus );
		CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
		// ACK o NACK ?
...
#ifdef DEBUG_I2C
		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_SL_L: 0x%02x,0x%02x\r\n\0"),txbyte,currentStatus );
		CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
		if ( (currentStatus & TWI_MASTER_RXACK_bm) != 0 )  goto i2c_exit;
	}
...
i2c_exit:
	if ( !ret_code ) {
//		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_REG_ERROR: 0x%02x,0x%02x\r\n\0"),txbyte,currentStatus );
//		CMD_write( stdout_buff, sizeof(stdout_buff) );
	}
	return(ret_code);
}
...
#ifdef DEBUG_I2C
	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_MWD: 0x%02x(%c),0x%02x\r\n\0"),txbyte,txbyte,currentStatus );
	CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
...
i2c_exit:
	if ( !ret_code ) {
//		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_MWD_ERROR: 0x%02x(%c),0x%02x\r\n\0"),txbyte,txbyte,currentStatus );
//		CMD_write( stdout_buff, sizeof(stdout_buff) );
	}
	return(ret_code);
}
...
#ifdef DEBUG_I2C
	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_SLR: 0x%02x(%c),0x%02x\r\n\0"),*rxByte,*rxByte,currentStatus );
	CMD_write( stdout_buff, sizeof(stdout_buff) );
#endif
...
i2c_exit:
	if ( !ret_code ) {
//		FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_SLR_ERROR: 0x%02x(%c),0x%02x\r\n\0"),*rxByte,*rxByte,currentStatus );
//		CMD_write( stdout_buff, sizeof(stdout_buff) );
	}
	return(ret_code);
}
...
uint8_t ticks_to_wait = 30;		// 3 ticks ( 30ms es el maximo tiempo que espero )
	...
	// DEBUG
//	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C TO 0x%02x\r\n\0"),TWIE.MASTER.STATUS );
//	CMD_write( stdout_buff, sizeof(stdout_buff) );
...
//	TWIE.MASTER.CTRLC =  TWI_MASTER_CMD_REPSTART_gc;	// Send START
	...
	// No pude pasarlo a IDLE: Error !!!
//	FRTOS_snprintf_P( stdout_buff,CHAR128,PSTR("I2C_RESET_TWI: 0x%02x\r\n\0"),TWIE.MASTER.STATUS );
//	CMD_write( stdout_buff, sizeof(stdout_buff) );
